                            ...
                            <div id="" class="clearfix top-bottom-padding">
                                <div class= "col-md-4 posRlt sm-top-bottom-padding" >
                                    ...
                                    <div id="taifo-block" class="home-4col-block">  
                                        <div class="row"><h2 class="block-title"><?php echo get_cat_name(28); ?></h2></div>
                                        <?php
                                        $args = array(
                                            'posts_per_page' => 6,
                                ...
                                <div class= "col-md-4 posRlt sm-top-bottom-padding" >
                                    ...
                                    <div id="taifo-block" class="home-4col-block">  
                                        <div class="row"><h2 class="block-title"><?php echo get_cat_name(29); ?></h2></div>
                                        <?php
                                        $args = array(
                                            'posts_per_page' => 6,
                                ...
                                <div class= "col-md-4 posRlt sm-top-bottom-padding" >
                                    ...
                                    <div id="taifo-block" class="home-4col-block">  
                                        <div class="row"><h2 class="block-title"><?php echo get_cat_name(30); ?></h2></div>
                                        <?php
                                        $args = array(
                                            'posts_per_page' => 6,
                            ...
                            <div class="clearfix three-in-one"  id="tupian-block">
                                ...
                                <div class="row">
                                    ...
                                    $args = array(
                                        ...
                                        'category__in' => array(11, 28, 29, 30)
                                    );
                                    $query = new WP_Query($args);
                                    ?>                                    
                                    <?php while ($query->have_posts()): $query->the_post(); ?>
